...
namespace Tactsoft.Service.DbDependencies
{
    public class AppDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        //particework
        public DbSet<IndustialType> IndustialTypes { get; set; }
        public DbSet<ServiceType> ServiceTypes { get; set; }

        public DbSet<JobCategory> JobCategorys { get; set; }

        public DbSet<JobSubCategory> JobSubCategorys { get; set; }
        ...
        public DbSet<ResumeReceivingOption> ResumeReceivingOptions { get; set; }

        public DbSet<Countrys> Countryss { get; set; }
